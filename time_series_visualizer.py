...
df = pd.read_csv(r'fcc-forum-pageviews.csv', parse_dates=['date'], index_col='date')
...
def draw_box_plot():
    ...
    sns.boxplot(x='year', y='value', data=df_box, ax=axes[0]).set(xlabel='Year', ylabel='Page Views')
